...
namespace BlazorApp.Client
{
    public class mnServiceManager
    {
        ...
        //private ServiceToken srvToken { get; set; }

        private mnUserManager userManager { get; set; }

        public mnServiceManager(HttpClient _http, mnTokenManager _tokenManager, ILocalStorageService _localStorage, mnUserManager _userManager)
        {
            Http = _http;
